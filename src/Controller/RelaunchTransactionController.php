...
class RelaunchTransactionController extends AbstractController
{
    /**
     ...
     * @return Response
     */
    public function relaunchTransaction(Request $request, $id = null): Response
    {
        $defaultData = ['send' => ''];
        ...
        if (($form->isSubmitted() && $form->isValid()) || $id !== null) {
            ...
            $transactionRequestService->relaunchTransaction($id);

            return $this->render('Transaction/RelaunchTransaction.html.twig', [
